...
public class TestCurlCustomer {

	public static void main(String[] args) throws Exception {

		// Deploy new apiProxy(o revision):
		// CmdUtils.execCommand("curl -k -v -H \"Content-Type: application/octet-stream\" -X POST https://api.enterprise.apigee.com/v1/o/livenation/apis?action=import&name=Deals -T C://deals.zip -u mgiorda@apigee.com:1234321Nomejodas");
		...
		// CmdUtils.execCommand("curl -k -v -X POST https://api.enterprise.apigee.com/v1/organizations/infogroup/developers/craig.schumann@infogroup.com/apps/MyTestApp/keys/KVFvu7AbygYXcWEzr9cg8cIH0y0Tk5Re?action=approve -u mgiorda@apigee.com:1234321Nomejodas");
		...
		// Worldbank queries.
		// Curl.get(
		// "https://api.enterprise.apigee.com/v1/o/worldbank/environments/prod/stats/apis?select=sum(message_count)&timeUnit=month&timeRange=08/20/2013%2000:00~10/01/2013%2000:00&filter=(apiproxy%20eq%20'worldbank')")
		// .setUser("mgiorda@apigee.com", "1234321Nomejodas").send();

		// Curl.get(
		// "https://api.enterprise.apigee.com/v1/o/worldbank/environments/prod/stats/domain?select=sum(message_count)&timeUnit=month&timeRange=08/01/2013%2000:00~08/31/2013%2023:59&filter=(apiproxy%20eq%20'worldbank')")
		// .setUser("mgiorda@apigee.com", "1234321Nomejodas").send();
		// ---------------------------------------------------
		// Curl.get(
		...
		Curl.get(
				"https://api.enterprise.apigee.com/v1/o/worldbank/environments/prod/stats/apis?select=sum(is_error)&timeUnit=month&timeRange=08/01/2013%2000:00~08/31/2013%2023:59&filter=(apiproxy%20eq%20'worldbank')")
				.setUser("mgiorda@apigee.com", "1234321Nomejodas").send();
	}
}
